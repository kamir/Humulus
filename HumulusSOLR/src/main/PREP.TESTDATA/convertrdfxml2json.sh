...
curl -F "userid=1" -F "filecomment=This is an RDF XML file" -F "content=@$1/$2" http://rdf-translator.appspot.com/convert/xml/rdf-json/content > $FLUME_SPOOL_DIR/$2.json
